...
def index(request):
    ...
    if request.method == "POST" and 'edit' in request.POST:
        ...
        person = Userinfo.objects.get(user_num=request.POST['num'])
    ...
    if request.method == "POST" and 'add' in request.POST:
        ...
        person.user_id = str(Userinfo.objects.last().user_num+1)
        person.user_password = str(Userinfo.objects.last().user_num+1)
        person.status=1
        person.save()
        return redirect('index')
